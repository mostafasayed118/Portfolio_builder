...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Layout & Sidebar >> sidebar has Inbox group with Messages
- Location: e2e\admin-full.spec.ts:51:9
...
Locator: locator('a:has-text("Messages")').first()
Expected: attached
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('a:has-text("Messages")').first()
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6xI7GcJRVW78U2qZmCr17akl
