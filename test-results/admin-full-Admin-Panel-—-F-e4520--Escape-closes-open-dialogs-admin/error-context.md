...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Keyboard Shortcuts >> Escape closes open dialogs
- Location: e2e\admin-full.spec.ts:450:9
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE70bAOAyXdiK3lXIwnp5AThWy
