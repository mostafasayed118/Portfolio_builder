...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Layout & Sidebar >> sidebar has Content group items
- Location: e2e\admin-full.spec.ts:43:9
...
Locator: locator('a:has-text("Hero")').first()
Expected: attached
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('a:has-text("Hero")').first()
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6xJRbjq4Azw4iD8ZtlCtQyrg
