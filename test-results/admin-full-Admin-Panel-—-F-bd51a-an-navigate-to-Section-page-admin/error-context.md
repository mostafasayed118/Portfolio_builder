...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Sidebar Navigation >> can navigate to Section page
...
Locator: locator('nav a:has-text("Section"), aside a:has-text("Section")').first()
Expected: attached
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('nav a:has-text("Section"), aside a:has-text("Section")').first()
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6ys6jANJnaUtvFyIPvXUvAoy
