...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Command Palette >> Escape closes command palette
- Location: e2e\admin-full.spec.ts:154:9
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6y5rEuKUbbNlHyhX6twN0E3z
