...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Layout & Sidebar >> sidebar has Dashboard group heading
- Location: e2e\admin-full.spec.ts:37:9
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6xKdi3CN9mJqncKJIlIBYrNR
