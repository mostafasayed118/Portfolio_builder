...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Skills Manager >> skills page has add button
- Location: e2e\admin-full.spec.ts:279:9
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE704cTWWhS1vsyBcSlE3soBUt
