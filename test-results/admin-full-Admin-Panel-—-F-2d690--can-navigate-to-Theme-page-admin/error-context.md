...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Sidebar Navigation >> can navigate to Theme page
...
Locator: locator('nav a:has-text("Theme"), aside a:has-text("Theme")').first()
Expected: attached
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('nav a:has-text("Theme"), aside a:has-text("Theme")').first()
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6ytgdwcadgW3b4IATGxjulBa
