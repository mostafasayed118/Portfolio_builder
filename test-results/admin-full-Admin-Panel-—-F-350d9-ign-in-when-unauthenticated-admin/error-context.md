...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Authentication >> protected routes redirect to sign-in when unauthenticated
- Location: e2e\admin-full.spec.ts:19:9
...
Expected pattern: /\/$/
Received string:  "http://localhost:5174/sign-in"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    6 × unexpected value "http://localhost:5174/overview"
    18 × unexpected value "http://localhost:5174/sign-in"
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6xMKZXiu6zxyGsLhI7MouB81
