...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Layout & Sidebar >> sidebar highlights active page with visual indicator
- Location: e2e\admin-full.spec.ts:65:9
...
Locator: locator('a[aria-current="page"], a[class*="bg-sidebar-primary"]').first()
Expected: attached
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('a[aria-current="page"], a[class*="bg-sidebar-primary"]').first()
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6xHNHB3CgoiEX8MvXgZZZaLe
