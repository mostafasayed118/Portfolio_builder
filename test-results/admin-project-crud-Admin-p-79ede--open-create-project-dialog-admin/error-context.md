...
- Name: admin-project-crud.spec.ts >> Admin project CRUD >> can open create project dialog
- Location: e2e\admin-project-crud.spec.ts:76:7
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE70mX7nUaVq8TBci9AEU3MsPS
