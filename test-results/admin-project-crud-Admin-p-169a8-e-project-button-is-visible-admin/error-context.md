...
- Name: admin-project-crud.spec.ts >> Admin project CRUD >> create project button is visible
- Location: e2e\admin-project-crud.spec.ts:70:7
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE70gcdzndTo4FqnhpU9LT4SYX
