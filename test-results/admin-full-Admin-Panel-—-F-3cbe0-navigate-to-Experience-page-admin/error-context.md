...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Sidebar Navigation >> can navigate to Experience page
...
Locator: locator('nav a:has-text("Experience"), aside a:has-text("Experience")').first()
Expected: attached
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('nav a:has-text("Experience"), aside a:has-text("Experience")').first()
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6ypXPW0JtEJJJ9ga0IySHA3D
