...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Sidebar Navigation >> can navigate to Overview page
...
Locator: locator('nav a:has-text("Overview"), aside a:has-text("Overview")').first()
Expected: attached
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('nav a:has-text("Overview"), aside a:has-text("Overview")').first()
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6ykeRgq1GEXvaOd2CE9BZx8h
