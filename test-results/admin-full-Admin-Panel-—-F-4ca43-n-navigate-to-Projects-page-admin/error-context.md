...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Sidebar Navigation >> can navigate to Projects page
...
Locator: locator('nav a:has-text("Projects"), aside a:has-text("Projects")').first()
Expected: attached
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('nav a:has-text("Projects"), aside a:has-text("Projects")').first()
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6z2dDjCsykdNnobu3jquYwyE
