...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Authentication >> sign-in page loads with Clerk component
- Location: e2e\admin-full.spec.ts:9:9
...
Locator: locator('[class*="sign-in"], iframe[src*="clerk"], [data-testid="sign-in"]').first()
Expected: attached
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[class*="sign-in"], iframe[src*="clerk"], [data-testid="sign-in"]').first()
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6xDY47QwPXtlAaic1FmbYWlN
