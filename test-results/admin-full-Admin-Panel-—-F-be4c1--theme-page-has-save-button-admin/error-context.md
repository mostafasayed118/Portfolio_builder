...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Theme Manager >> theme page has save button
- Location: e2e\admin-full.spec.ts:391:9
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE70TIFDN00rxWNoOkstX5X1Sk
