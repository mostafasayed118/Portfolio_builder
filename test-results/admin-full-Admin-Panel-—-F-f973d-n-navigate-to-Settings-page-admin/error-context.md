...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Sidebar Navigation >> can navigate to Settings page
...
Locator: locator('nav a:has-text("Settings"), aside a:has-text("Settings")').first()
Expected: attached
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('nav a:has-text("Settings"), aside a:has-text("Settings")').first()
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6yyJenKkdhOd4Q00wNKn2YoN
