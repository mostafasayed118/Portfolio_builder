...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Layout & Sidebar >> header has theme toggle button
- Location: e2e\admin-full.spec.ts:77:9
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6xI8JiFYzYMYwvj74BLJsCOr
