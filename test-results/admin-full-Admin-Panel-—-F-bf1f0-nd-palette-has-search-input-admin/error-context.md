...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Command Palette >> command palette has search input
- Location: e2e\admin-full.spec.ts:116:9
...
Locator: locator('[role="dialog"] input, [cmdk-input]').first()
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for locator('[role="dialog"] input, [cmdk-input]').first()
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6xYi3bImsoDHdSr0UV7snfhb
