...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Sidebar Navigation >> can navigate to Skills page
...
Locator: locator('nav a:has-text("Skills"), aside a:has-text("Skills")').first()
Expected: attached
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('nav a:has-text("Skills"), aside a:has-text("Skills")').first()
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6yYSTS2J1Fsxj2Zj8cVQ3Feq
