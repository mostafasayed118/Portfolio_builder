...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Command Palette >> Ctrl+K opens command palette
- Location: e2e\admin-full.spec.ts:108:9
...
Locator: locator('[role="dialog"], [cmdk-root], [class*="command"]').first()
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for locator('[role="dialog"], [cmdk-root], [class*="command"]').first()
...
- link "Sign up":
  - /url: https://nearby-koi-38.accounts.dev/sign-up?__clerk_db_jwt=dvb_3EE6xTSnkimKOKf4VPox4b0LEhw
