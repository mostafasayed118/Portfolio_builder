...
// Project CRUD renders only for a real signed-in session; skip cleanly on
// the CI stub (see e2e/lib/session-mode.ts).
test.skip(!hasRealAdminSession(), "Admin project CRUD needs a real Clerk session (set CLERK_TEST_EMAIL / CLERK_TEST_PASSWORD)");
