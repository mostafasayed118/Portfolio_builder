...
-- 014_images.sql created trg_image_metadata_updated_at using update_updated_at()
-- 017_updated_at_triggers.sql created update_image_metadata_updated_at using update_updated_at_column()
