...
- Name: admin-full.spec.ts >> Admin Panel — Full Manual Test Suite >> Overview Dashboard >> overview shows module grid with links to sections
- Location: e2e\admin-full.spec.ts:223:9
